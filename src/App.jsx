    ...
    <>
      <nav className="up-navbar">
        ...
        <div className="main-nav">
          <div className="box" style={{ fontWeight: 'bold', fontSize: '30px', cursor : 'pointer' }} onClick={()=>{navigate('/')}}>YOGO</div>
          <div className="box">
            <ul>
              <li onClick={()=>{navigate('/sale-products')}}>요고특가</li>
              <li onClick={()=>{navigate('/')}}>모든상품</li>
              <li onClick={()=>{navigate('/')}}>리뷰</li>
      ...
      <div style={{borderBottom: '1px solid rgb(233, 233, 233)', borderTop: '1px solid rgb(233, 233, 233)',  height: '300px'}}>
